...
class FINPrivacyPolicyVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://develop.backendless.com/BDCD56B9-351A-E067-FFA4-9EA9CF2F4000/console/fcfdrgddsebccdkjfamuhppaasnowqluooks/files/view/web/privacypolicy.htm");
